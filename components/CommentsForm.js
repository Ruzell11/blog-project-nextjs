      ...
      <div className='grid grid-cols-1 gap-4 mb-2'>
        ...
        <div className='grid grid-cols-1 gap-4 mb-2  mx-auto w-100'>
          <button type='button' onClick={handleSubmit}
            className='btn rounded-full py-2 px-2 bg-blue-700 transition duration-400 ease-in hover:bg-pink-500  text-white  '>
            Post Message
          </button>
          {showSucessMessage && <span className='text-xl float-right text-green-500'>Comment submitted for review</span>}
        </div>
